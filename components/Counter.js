                ...
                <div className="funfact-one__single">
                  <h3 className="counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 7842 : 0} />
                    </VisibilitySensor>
                  </h3>
                  <p>Cursos</p>
                </div>
                ...
                <div className="funfact-one__single">
                  <h3 className="counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 6020 : 0} />
                    </VisibilitySensor>
                  </h3>
                  <p>Estudiantes</p>
                </div>
                ...
                <div className="funfact-one__single">
                  <h3 className="counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 360 : 0} />
                    </VisibilitySensor>
                  </h3>
                  <p>cursos</p>
                </div>
                ...
                <div className="funfact-one__single">
                  <h3 className="counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 200 : 0} />
                    </VisibilitySensor>
                  </h3>
                  <p>Instituciones</p>
                </div>
