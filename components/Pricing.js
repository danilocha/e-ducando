      ...
      <section className="pricing-one" id="pricing">
        <div className="container">
          ...
          <div className="tabed-content">
            <div
              id="month"
              style={{ display: this.state.month ? "block" : "none" }}
            >
              <div className="row">
                <div
                  ...
                  <div className="pricing-one__single">
                    <div className="pricing-one__inner">
                      ...
                      <ul className="list-unstyled pricing-one__list">
                        <li>
                          <i className="fa fa-check"></i> Extra features
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Lifetime free support
                        </li>
                        <li>
                          <i className="fa fa-check"></i> Upgrate options
                        </li>
                        <li>
            ...
            <div
              id="year"
              style={{ display: this.state.year ? "block" : "none" }}
            >
              <div className="row">
                <div
                  className="col-lg-4 wow fadeInLeft"
